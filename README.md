...
Code to support my slides for "Anayzing Structured Data with AI".  Code in `src` scrapes Eric Longenhagen's 2025 Top 100 prospects, passes those reports to Claude for analysis, then analyzes the Claude results.
